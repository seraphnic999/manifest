...
const styles = StyleSheet.create({
  ...
  addPersonChip: {
    ...
    borderColor: colors.lightBlue, borderStyle: "dashed", backgroundColor: "transparent",
  },
  addPersonChipText: { color: colors.lightBlue, fontWeight: "600", fontSize: 12 },
  addPersonCard: {
  ...
  viewLinkText: { color: colors.lightBlue, fontSize: 11, fontWeight: "600", marginTop: 8 },
  addRowText: { color: colors.lightBlue, fontWeight: "600", fontSize: 13, marginTop: 4 },
