...
const styles = StyleSheet.create({
  ...
  percent: { fontFamily: "JetBrainsMono_600SemiBold", color: colors.lightBlue, fontWeight: "700", fontSize: 14 },
  percentOver: { color: colors.coral },
  track: { height: 10, backgroundColor: colors.paper, borderRadius: 6, overflow: "hidden" },
  fill: { height: 10, backgroundColor: colors.lightBlue, borderRadius: 6 },
